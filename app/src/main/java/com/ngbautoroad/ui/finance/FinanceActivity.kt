...
 
 / /   = = =   A B A   D E   M A N U T E N � � E S   R E A I S   ( S p r i n t   3 )   = = = 
 
 @ O p t I n ( a n d r o i d x . c o m p o s e . m a t e r i a l 3 . E x p e r i m e n t a l M a t e r i a l 3 A p i : : c l a s s ) 
 @ C o m p o s a b l e 
 f u n   M a i n t e n a n c e R e c o r d s T a b ( 
         m a i n t e n a n c e R e c o r d D a o :   c o m . n g b a u t o r o a d . d a t a . d b . M a i n t e n a n c e R e c o r d D a o , 
         s n a c k b a r H o s t S t a t e :   S n a c k b a r H o s t S t a t e 
 )   { 
         v a l   c o r o u t i n e S c o p e   =   r e m e m b e r C o r o u t i n e S c o p e ( ) 
         v a l   r e c o r d s   b y   m a i n t e n a n c e R e c o r d D a o . g e t A l l R e c o r d s ( ) . c o l l e c t A s S t a t e ( i n i t i a l   =   e m p t y L i s t ( ) ) 
 
         v a r   s h o w D i a l o g   b y   r e m e m b e r   {   m u t a b l e S t a t e O f ( f a l s e )   } 
 
         C o l u m n ( m o d i f i e r   =   M o d i f i e r . f i l l M a x S i z e ( ) . p a d d i n g ( 1 6 . d p ) )   { 
                 B u t t o n ( o n C l i c k   =   {   s h o w D i a l o g   =   t r u e   } ,   m o d i f i e r   =   M o d i f i e r . f i l l M a x W i d t h ( ) )   { 
                         T e x t ( " R e g i s t r a r   M a n u t e n � � o   R e a l " ) 
                 } 
 
                 S p a c e r ( m o d i f i e r   =   M o d i f i e r . h e i g h t ( 1 6 . d p ) ) 
 
                 i f   ( r e c o r d s . i s E m p t y ( ) )   { 
                         T e x t ( " N e n h u m   r e g i s t r o   d e   m a n u t e n � � o   r e a l . " ,   s t y l e   =   M a t e r i a l T h e m e . t y p o g r a p h y . b o d y M e d i u m ) 
                 }   e l s e   { 
                         L a z y C o l u m n ( m o d i f i e r   =   M o d i f i e r . f i l l M a x S i z e ( ) )   { 
                                 i t e m s ( r e c o r d s )   {   r e c o r d   - > 
                                         C a r d ( 
                                                 m o d i f i e r   =   M o d i f i e r . f i l l M a x W i d t h ( ) . p a d d i n g ( v e r t i c a l   =   4 . d p ) , 
                                                 c o l o r s   =   C a r d D e f a u l t s . c a r d C o l o r s ( c o n t a i n e r C o l o r   =   M a t e r i a l T h e m e . c o l o r S c h e m e . s u r f a c e V a r i a n t ) 
                                         )   { 
                                                 C o l u m n ( m o d i f i e r   =   M o d i f i e r . p a d d i n g ( 1 6 . d p ) )   { 
                                                         R o w ( 
                                                                 m o d i f i e r   =   M o d i f i e r . f i l l M a x W i d t h ( ) , 
                                                                 h o r i z o n t a l A r r a n g e m e n t   =   A r r a n g e m e n t . S p a c e B e t w e e n 
                                                         )   { 
                                                                 T e x t ( r e c o r d . m a i n t e n a n c e T y p e ,   f o n t W e i g h t   =   F o n t W e i g h t . B o l d ) 
                                                                 T e x t ( " R $   $ { " % . 2 f " . f o r m a t ( r e c o r d . t o t a l C o s t ) } " ,   f o n t W e i g h t   =   F o n t W e i g h t . B o l d ,   c o l o r   =   M a t e r i a l T h e m e . c o l o r S c h e m e . p r i m a r y ) 
                                                         } 
                                                         T e x t ( " P e � a s :   $ { r e c o r d . r e p l a c e d P a r t s } " ,   s t y l e   =   M a t e r i a l T h e m e . t y p o g r a p h y . b o d y M e d i u m ) 
                                                         T e x t ( " O d � m e t r o :   $ { r e c o r d . o d o m e t e r }   k m " ,   s t y l e   =   M a t e r i a l T h e m e . t y p o g r a p h y . b o d y M e d i u m ) 
                                                         i f   ( r e c o r d . n o t e s . i s N o t E m p t y ( ) )   { 
                                                                 T e x t ( " N o t a :   $ { r e c o r d . n o t e s } " ,   s t y l e   =   M a t e r i a l T h e m e . t y p o g r a p h y . b o d y S m a l l ,   c o l o r   =   C o l o r . G r a y ) 
                                                         } 
                                                         S p a c e r ( m o d i f i e r   =   M o d i f i e r . h e i g h t ( 8 . d p ) ) 
                                                         B u t t o n ( 
                                                                 o n C l i c k   =   { 
                                                                         c o r o u t i n e S c o p e . l a u n c h   { 
                                                                                 m a i n t e n a n c e R e c o r d D a o . d e l e t e ( r e c o r d ) 
                                                                                 s n a c k b a r H o s t S t a t e . s h o w S n a c k b a r ( " R e g i s t r o   r e m o v i d o " ) 
                                                                         } 
                                                                 } , 
                                                                 c o l o r s   =   B u t t o n D e f a u l t s . b u t t o n C o l o r s ( c o n t a i n e r C o l o r   =   M a t e r i a l T h e m e . c o l o r S c h e m e . e r r o r ) 
                                                         )   { 
                                                                 T e x t ( " R e m o v e r " ) 
                                                         } 
                                                 } 
                                         } 
                                 } 
...
         } 
 
         i f   ( s h o w D i a l o g )   { 
                 v a r   m a i n t e n a n c e T y p e   b y   r e m e m b e r   {   m u t a b l e S t a t e O f ( " P R E V E N T I V A " )   } 
                 v a r   t o t a l C o s t   b y   r e m e m b e r   {   m u t a b l e S t a t e O f ( " " )   } 
                 v a r   r e p l a c e d P a r t s   b y   r e m e m b e r   {   m u t a b l e S t a t e O f ( " " )   } 
                 v a r   o d o m e t e r   b y   r e m e m b e r   {   m u t a b l e S t a t e O f ( " " )   } 
                 v a r   n o t e s   b y   r e m e m b e r   {   m u t a b l e S t a t e O f ( " " )   } 
 
                 A l e r t D i a l o g ( 
                         o n D i s m i s s R e q u e s t   =   {   s h o w D i a l o g   =   f a l s e   } , 
                         t i t l e   =   {   T e x t ( " N o v a   M a n u t e n � � o   R e a l " )   } , 
                         t e x t   =   { 
                                 C o l u m n   { 
                                         R o w ( v e r t i c a l A l i g n m e n t   =   A l i g n m e n t . C e n t e r V e r t i c a l l y )   { 
                                                 R a d i o B u t t o n ( s e l e c t e d   =   m a i n t e n a n c e T y p e   = =   " P R E V E N T I V A " ,   o n C l i c k   =   {   m a i n t e n a n c e T y p e   =   " P R E V E N T I V A "   } ) 
                                                 T e x t ( " P r e v e n t i v a " ,   m o d i f i e r   =   M o d i f i e r . p a d d i n g ( e n d   =   8 . d p ) ) 
                                                 R a d i o B u t t o n ( s e l e c t e d   =   m a i n t e n a n c e T y p e   = =   " C O R R E T I V A " ,   o n C l i c k   =   {   m a i n t e n a n c e T y p e   =   " C O R R E T I V A "   } ) 
                                                 T e x t ( " C o r r e t i v a " ) 
                                         } 
                                         O u t l i n e d T e x t F i e l d ( 
                                                 v a l u e   =   r e p l a c e d P a r t s , 
                                                 o n V a l u e C h a n g e   =   {   r e p l a c e d P a r t s   =   i t   } , 
                                                 l a b e l   =   {   T e x t ( " P e � a s / S e r v i � o   ( e x :   T r o c a   d e   p n e u s ) " )   } , 
                                                 m o d i f i e r   =   M o d i f i e r . f i l l M a x W i d t h ( ) . p a d d i n g ( v e r t i c a l   =   4 . d p ) 
                                         ) 
                                         O u t l i n e d T e x t F i e l d ( 
                                                 v a l u e   =   t o t a l C o s t , 
                                                 o n V a l u e C h a n g e   =   {   t o t a l C o s t   =   i t   } , 
                                                 l a b e l   =   {   T e x t ( " C u s t o   T o t a l   ( R $ ) " )   } , 
                                                 k e y b o a r d O p t i o n s   =   K e y b o a r d O p t i o n s ( k e y b o a r d T y p e   =   K e y b o a r d T y p e . N u m b e r ) , 
                                                 m o d i f i e r   =   M o d i f i e r . f i l l M a x W i d t h ( ) . p a d d i n g ( v e r t i c a l   =   4 . d p ) 
                                         ) 
                                         O u t l i n e d T e x t F i e l d ( 
                                                 v a l u e   =   o d o m e t e r , 
                                                 o n V a l u e C h a n g e   =   {   o d o m e t e r   =   i t   } , 
                                                 l a b e l   =   {   T e x t ( " O d � m e t r o   a t u a l   ( k m ) " )   } , 
                                                 k e y b o a r d O p t i o n s   =   K e y b o a r d O p t i o n s ( k e y b o a r d T y p e   =   K e y b o a r d T y p e . N u m b e r ) , 
                                                 m o d i f i e r   =   M o d i f i e r . f i l l M a x W i d t h ( ) . p a d d i n g ( v e r t i c a l   =   4 . d p ) 
                                         ) 
                                         O u t l i n e d T e x t F i e l d ( 
                                                 v a l u e   =   n o t e s , 
                                                 o n V a l u e C h a n g e   =   {   n o t e s   =   i t   } , 
                                                 l a b e l   =   {   T e x t ( " O b s e r v a � � e s   ( o p c i o n a l ) " )   } , 
                                                 m o d i f i e r   =   M o d i f i e r . f i l l M a x W i d t h ( ) . p a d d i n g ( v e r t i c a l   =   4 . d p ) 
                                         ) 
                                 } 
                         } , 
                         c o n f i r m B u t t o n   =   { 
                                 T e x t B u t t o n ( o n C l i c k   =   { 
                                         c o r o u t i n e S c o p e . l a u n c h   { 
                                                 v a l   c o s t   =   t o t a l C o s t . c o m . n g b a u t o r o a d . u t i l . t o D o u b l e L o c a l e O r N u l l ( )   ? :   0 . 0 
                                                 v a l   o d o   =   o d o m e t e r . t o I n t O r N u l l ( )   ? :   0 
                                                 i f   ( r e p l a c e d P a r t s . i s N o t B l a n k ( )   & &   c o s t   >   0 . 0 )   { 
                                                         m a i n t e n a n c e R e c o r d D a o . i n s e r t ( 
                                                                 c o m . n g b a u t o r o a d . d a t a . d b . M a i n t e n a n c e R e c o r d E n t i t y ( 
                                                                         m a i n t e n a n c e T y p e   =   m a i n t e n a n c e T y p e , 
                                                                         r e p l a c e d P a r t s   =   r e p l a c e d P a r t s , 
                                                                         t o t a l C o s t   =   c o s t , 
                                                                         o d o m e t e r   =   o d o , 
                                                                         n o t e s   =   n o t e s 
                                                                 ) 
                                                         ) 
                                                         s n a c k b a r H o s t S t a t e . s h o w S n a c k b a r ( " M a n u t e n � � o   s a l v a ! " ) 
                                                         s h o w D i a l o g   =   f a l s e 
                                                 }   e l s e   { 
                                                         s n a c k b a r H o s t S t a t e . s h o w S n a c k b a r ( " P r e e n c h a   p e � a   e   v a l o r   v � l i d o . " ) 
                                                 } 
                                         } 
                                 } )   { 
                                         T e x t ( " S a l v a r " ) 
...
                                 T e x t B u t t o n ( o n C l i c k   =   {   s h o w D i a l o g   =   f a l s e   } )   {   T e x t ( " C a n c e l a r " )   } 
                         } 
                 ) 
         } 
 } 
